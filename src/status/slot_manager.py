...
# ---------------------------------------------------------------------------
# SlotManager — persistent state for ONE pricing session
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# check_slots — reads SlotManager state, decides next action
# ---------------------------------------------------------------------------
...
#     options: Optional[list] = None #option that that we can choose it from 
#     field: Optional[str] = None #missing pramaters that is related to products parameters
